...
// 		alert(objetoSelPos);
	...
	//alert("saliendo "+dashTotal);
	//alert("saliendo "+indiceDashTotal);
}
...
<table align="center" width="100%" >
    	...
    	<tr>
    		<td>
    		    ...
    		    <button type="button" id="dashboard3" class="btn btn-info" autocomplete="off" onclick="graficasingenieria();limpiaDashboard();splitFuncion()">
					Control y Mejora
				</button>
    		</td>
    		<td>
        ...
        <tr>
            ...
            <td width="95%" valign="top">
            	<form id="guardaDas" action="guardarDashboard" method="post">
	                <div width="100%" height="200px" id="contenedorGraficas" name="contenedorGraficas"><br>
	                <div id="indicadorGrafica" style="height:210px; width:87%" class="areagrafica">
	        <img src="ImagenesADN/cerrar.png" align="left" id="botonQuitarInd" onclick="quitaGraficaInd()">
			
			<div id="graficamodelo"  style="width: 250px; height: 200px; margin: 0 auto; float: left"></div>
			<div id="graficascala"  style="width: 250px; height: 200px; margin: 0 auto; float: left"></div>
			<div id="graficaaudi"  style="width: 250px; height: 200px; margin: 0 auto; float: left"></div>
			<div id="graficabancomer"  style="width: 250px; height: 200px; margin: 0 auto; float: left"></div>
			
			</div>       
			<div>
			<div id="indicadorGrafica" style="height:310px; width:1050px; float:left" class="areagrafica">
	        <img src="ImagenesADN/cerrar.png" align="left" id="botonQuitarInd" onclick="quitaGraficaInd()">
			<label align="center" value="" id="label1" class="titulodivs">Desempeño del Equipo Control y Mejora</label>
			<div id="graficahoras"  style="width: 98%; height: 90%; margin: 0 auto; float: left"></div>
...
$(function () {
    ...
    // The speed gauge
    $('#graficabancomer').highcharts(Highcharts.merge(gaugeOptions, {
        yAxis: {
            min: 0,
            max: 100,
            title: {
                text: 'Desviacion en Inventarios'
            }
        },
        ...
        series: [{
            name: 'Desviacion en Inventarios',
            data: [100],
            dataLabels: {
                format: '<div style="text-align:center"><span style="font-size:25px;color:' +
                    ((Highcharts.theme && Highcharts.theme.contrastTextColor) || 'black') + '">{y}</span><br/>' +
                       '<span style="font-size:12px;color:silver">% de avance</span></div>'
            },
            tooltip: {
                valueSuffix: ' %'
            }
    ...
    // The RPM gauge
    $('#graficamodelo').highcharts(Highcharts.merge(gaugeOptions, {
        yAxis: {
            min: 0,
            max: 100,
            title: {
                text: 'Inventarios Obsoletos'
            }
        },
     ...
     $('#graficaaudi').highcharts(Highcharts.merge(gaugeOptions, {
        yAxis: {
            min: 0,
            max: 100,
            title: {
                text: 'Dias de Ciclo de Efectivo'
            }
        },
     ...
     $('#graficascala').highcharts(Highcharts.merge(gaugeOptions, {
        yAxis: {
            min: 0,
            max: 100,
            title: {
                text: 'Indice de Quejas y Desviaciones'
            }
        },
