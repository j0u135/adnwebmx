...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <script src="js/cargaArchivoCsvInd.js"></script>
...
<div id="CargaXindicador" class="modconf">
<form method="POST" id="cargaCsvIndicador" action="CargaArchivoXindicador">
...
<div id="escondidos"></div>
	<table class="forma2" width="80%" align="center">
		...
		<tr>
			...
			<td align="left"><select id="cbAnio" class="form-control" style="width: 100px; padding: 2px 2px 2px 2px" onchange="llenaCbInd()"></select></td>
			<td align="right"><span>Indicador</span></td>
			<td align="left"><select id="indicador" class="form-control" style="width: 250px; padding: 2px 2px 2px 2px"  disabled="disabled" onchange="validaReq();"></select></td>
			<td align="right"><span>Archivo</span></td>
			<td align="left"><input type="file" id="fileInputInd" class="form-control" style="width: 300px" accept=".csv" onchange="processFiles(this.files)" disabled="disabled"></input></td>
		</tr>
		<tr><td colspan="6" height="5px"></td></tr>
		<tr>
			<td colspan="6">
		...
		<tr>
			...
			<td colspan="1"></td>
			<td colspan="2" height="50px">
				<div id="alerta" class="alert alert-warning" role="alert"  style="display: none;">Valida el mes</div>
			</td>
