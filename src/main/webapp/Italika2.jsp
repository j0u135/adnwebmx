...
<tr>
		<div class="menu" align= "left">
				...
				<div class= "barrabotones" style="display:inline-block" >
	    			...
	    			<select class="form-selectl" id="division" onchange="cambiaframe()">
	    	 	...
	    	 	<div id="grafAct"style="display:inline-block;" onclick="cambiaframe();" >,<a href><img src="ImagenesADN/grafica-linea1.png" width="25px" height="25px"/></a></div>  	 			
                <div id="grafAct"style="display:none;"><img src="ImagenesADN/grafica-linea1.png" width="25px" height="25px"/></div>  	 			
...
<tr>
	<div class="panel panel-primary">
	 ...
	 <iframe src="https://docs.google.com/a/10x.mx/spreadsheets/d/13-Q9sChr_3l1KfAVrT1NztJkUyKqxsmbelWee90Jfo4/edit#gid=0;single=true&amp;widget=true&amp;headers=false" width="100%" height="800px"></iframe>
	 </div>
	 </div>
</tr>
...
function cambiaframe(){
	...
	select=document.getElementById("division").value;
	if(select=="7555")
		{
