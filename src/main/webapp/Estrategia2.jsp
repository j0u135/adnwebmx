	...
	<div class="modulo">
		<div class="modizquierda">
			...
			<div class="mods">
				...
				<h2>Estrategia<br>¿En dónde jugamos?</h2>
				<div class="modmenu">
					<p>Oportunidad</p>
					<p>Segmento</p>
		...
		<div class="modconf">
			...
			<div class="modulotitulos">
				<table align="center" width="100%">
					<tr>
						<td align="center" width="33%"><h1>ESTRATEGIA</h1></td>
						<td align="center" width="33%"><h2>¿En dónde jugamos?</h2></td>
			...
			<div class="modnuevo">
				<div class="modajustes">
					<span class="ajuste">Oportunidad</span> <span class="boton"><i class="fa fa-times"></i></span>
				</div>
				<table width="100%" align="center" class="sinborde">
					<tr>
						<td><input type="text" class="vacio" value=""></td>
					</tr>
					<tr>
						<td><input type="text" class="vacio" value=""></td>
					</tr>
			...
			<div class="modnuevo">
				<table align="center" width="100%" class="plana">
					<tr>
						<td width="33%">
							<div class="modajustes">
								<span class="ajuste">Industria</span> <span class="boton"><i class="fa fa-times"></i></span>
							</div>
							<table align="center" width="100%" class="sinborde">
								<tr>
									<td><input type="text" class="vacio" value=""></td>
								</tr>
								<tr>
						...
						<td width="33%">
							<div class="modajustes">
								<span class="ajuste">Clientes</span> <span class="boton"><i class="fa fa-times"></i></span>
							</div>
							<table align="center" width="100%" class="sinborde">
								<tr>
									<td><input type="text" class="vacio" value=""></td>
						...
						<td width="33%">
							<div class="modajustes">
								<span class="ajuste">Competencia</span> <span class="boton"><i class="fa fa-times"></i></span>
							</div>
							<table align="center" width="100%" class="sinborde">
								<tr>
									<td><input type="text" class="vacio" value=""></td>
			...
			<div class="modnuevo">
				<div class="modajustes">
					<span class="ajuste">Modelo de negocio</span> <span class="boton"><i class="fa fa-times"></i></span>
				</div>
				<table width="100%" align="center" class="sinborde">
					<tr>
						<td><input type="text" class="vacio" value=""></td>
