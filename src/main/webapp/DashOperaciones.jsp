        		...
        		<table align="center" width="100%">
			       <tr>
			            <td colspan="4" align="center">
							...
							<div id="" style="display:inline-block"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('direccion','','ImagenesADN/Nmenu/planeacion-rollover.png',1)"><img src="ImagenesADN/Nmenu/planeacion-normal.png" name="direccion" width="77" height="79" border="0" id="direccion" onclick="linkDir('Estrategia.jsp')"/> </a></div>
							<div id="" style="display:inline-block"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('gerencia','','ImagenesADN/Nmenu/arbol-rollover.png',1)"><img src="ImagenesADN/Nmenu/arbol-normal.png" name="gerencia" width="89" height="79" border="0" id="gerencia" onclick="linkDir('arbolIndicadoresADN.jsp')"/></a></div>
    ...
    <table align="center" width="1200px" >
    	<tr>
    		<td>
    			...
    			<input type="button" value="Operaciones" onclick="Italika2.jsp">
        ...
        <tr>
            ...
            <td width="95%" valign="top">
            	<form id="guardaDas" action="guardarDashboard" method="post">
	                <div width="100%" height="800px" id="contenedorGraficas1" name="contenedorGraficas"></div>
	 				
	                <iframe src="https://sites.google.com/a/10x.mx/blanco/home;single=true&amp;widget=true&amp;headers=false" width="100%" height="800px"></iframe>
