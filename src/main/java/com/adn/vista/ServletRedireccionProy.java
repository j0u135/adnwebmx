 ...
 */
@WebServlet("/ServletRedireccionProy")
public class ServletRedireccionProy extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletRedireccionProy() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 ...
		 String pesoTotal=request.getParameter("pesoTotal"); 
		 ...
		 String nombreP="", unidadP="", fechaP="", inicialP="", programadoP="", realP="", pesoP="", fechaI="";
		   ...
		   if(valor!=null && !valor.equals("")){
			   ...
			   Prioridad prio=ClaseProyectosPrioritarios.consultarPP(valor,usuarioHR);
			   ...
			   if(arrActividad!=null && arrActividad.size()>0){
				...
				if(prioMes!=null){
					programadoP=prioMes.getAvanceProgramado()!=null?prioMes.getAvanceProgramado():"";
					realP=prioMes.getAvanceReal()!=null?prioMes.getAvanceReal():"";
					pesoP=prioMes.getPeso()!=null?prioMes.getPeso():"";
				}
