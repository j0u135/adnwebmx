 ...
 */
@WebServlet("/CargaArchivoXindicador")
public class CargaArchivoXindicador extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CargaArchivoXindicador() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(numReg != null && numReg != ""){
			...
			for(int i = 1; i<totReg; i++){ //Se revisa registro por registro
		   	...
		   	//	IndicadorInteligente ii = new IndicadorInteligente(nbIndicador, "","", "","","", "",anio, nbMes.substring(0, 3).toLowerCase(), nuevoMes);
