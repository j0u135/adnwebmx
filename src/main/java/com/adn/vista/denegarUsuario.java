...
/**
 * Servlet implementation class denegarUsuario
 */
@WebServlet("/denegarUsuario")
public class denegarUsuario extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public denegarUsuario() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String mailAprobador=request.getParameter("mailAprobador1");//nombre
		String nbAprobador = request.getParameter("nombreAprobador1");
		String usuarioSesion = request.getParameter("usuarioSes1");
		String comentario = request.getParameter("comentDenega");
		String usuAprobado=request.getParameter("acAprobado1");	//naprobador
		String mes=request.getParameter("mesApro1");		//mes
		String numApro = request.getParameter("numApro1");
		String nomUsuSel="";
		...
		if(uAprobado!= null){
			...
			Email e1 = new Email("sistema_adn@10x.mx","SistemaADN2015",uAprobado.getCorreo(),"Solicitud denegada","Este correo es generado por ADN \nEstimado "+uAprobado.getNombre()+"\nEl siguiente aprobador a denegado su hoja de rumbo\nUsuario: "+nbAprobador+"\n Comentarios: "+comentario+"\nPor favor revicela.");
			if (e1.sendMail()){
		...
		estatus = "Denegada";
		System.out.println(raproNum+"-"+mes+"-"+fechaAct+"-"+usuAprobado+"-"+aproOb+"-"+estatus);
		ClaseHojaRumbo.denegarUsu(raproNum,mes,usuAprobado,aproOb,estatus);
		...
		if(arrHoRu!=null){
			for(int i=0; i<arrHoRu.size();i++){
				...
				nbApro1=horu.getNbApro1();
				nbApro2=horu.getNbApro2();
				nbApro3=horu.getNbApro3();
				nbApro4=horu.getNbApro4();
				...
				estat = horu.getEstatus();
				usuApro1=horu.getUsuApro1();
				usuApro2=horu.getUsuApro2();
				usuApro3=horu.getUsuApro3();
				usuApro4=horu.getUsuApro4();
			}
		}
		 request.setAttribute("comentarios", arrComents);
		   ...
		   request.setAttribute("mensajeSolicitud", new String("Su hoja de rumbo a sido denegada."));
