...
@WebServlet("/getHojaRutaByDepartamentoYYear")
public class GetHojaRutaByDepartamentoYYear extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public GetHojaRutaByDepartamentoYYear() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<ReporteUsuariosHojaRuta> lista_reportes = hojaruta_dao.getHojaRumboByDepartamentoYYear(paso_inf.getId_departamento(), paso_inf.getYear(), consultante);
